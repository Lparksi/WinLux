...
- [요구 사항](#요구-사항)
- [빠른 시작](#빠른-시작)
- [메인 창 지연 생성 및 자동 파기](#메인-창-지연-생성-및-자동-파기)
- [스크립트](#스크립트)
- [검증](#검증)
- [프로젝트 구조](#프로젝트-구조)
...
앱은 시작 시 메인 창을 렌더링하지 않으며, 트레이 아이콘으로 제어할 수 있습니다.

## 메인 창 지연 생성 및 자동 파기

- 시작 시 메인 WebView 창을 생성하지 않고, 트레이와 백그라운드 기능만 상주합니다.
- 트레이 왼쪽 클릭 또는 "메인 창 열기"를 눌렀을 때 UI를 생성하여 표시합니다.
- 메인 창을 닫으면 먼저 숨김 처리되고, 3분 후 창 인스턴스를 자동으로 파기합니다.
- 3분 이내에 트레이에서 다시 열면 파기 대기가 취소되고 창을 유지/재생성합니다.
